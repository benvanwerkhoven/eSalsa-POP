...
!
! !REVISION HISTORY:
!  SVN:$Id: diagnostics.F90 17212 2009-07-20 23:01:42Z njn01 $
!
! !USES:
...
!-----------------------------------------------------------------------
      ...
      call document ('diag_print', 'file written: '/&
                                                   &/ trim(diag_outfile))
...
!maltrud possible bug

      deallocate(mass_tran, &
               heat_tran, &
               salt_tran)

      call document ('diag_transport', 'file written: '/&
                                                      &/trim(diag_transport_outfile))
